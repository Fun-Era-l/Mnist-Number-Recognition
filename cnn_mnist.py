...
def main(unused_argv):
  ...
  if predicting:
      ...
      # # img_png.show()
      imagePath = 'F:/codes/python/NumberRecognition/er.png'
      # # 使用cv2.IMREAD_GRAYSCALE 读取灰度图
      # image = cv2.imread('F:/codes/python/NumberRecognition/er.png',cv2.IMREAD_GRAYSCALE)
      image = polarize.polarize(imagePath)
      ...
      #     img_np[0] = first_array.reshape(1,784)
      #     img_np[1] = np.array(second,dtype=np.float32).reshape(1,784)
      # else:
      #     img_np = first_array
